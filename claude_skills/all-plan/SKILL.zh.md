---
name: all-plan
description: 基于抽象角色进行协作规划（designer + inspiration + reviewer）
metadata:
  short-description: 基于抽象角色进行协作规划（designer + inspiration + reviewer）
---

# All Plan（Claude 版本）

基于 CLAUDE.md 角色分配表中的抽象角色进行协作规划。
