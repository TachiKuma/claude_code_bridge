    ...
    *,
    ...
    if spec.provider == 'codex':
        ...
        profile = ResolvedProviderProfile(
            ...
            codex_config=dict(profile_spec.codex_config),
            codex_model_aliases=dict(profile_spec.codex_model_aliases),
            codex_requires_openai_auth=profile_spec.codex_requires_openai_auth,
    ...
    *,
    ...
    if materialize_home:
        materialize_codex_home_config(
            ...
            model=spec.model,
            model_aliases=profile_spec.codex_model_aliases,
