...
def render_doctor(payload: Mapping[str, object]) -> tuple[str, ...]:
    ...
    lines = [
        ...
        f'ccbd_namespace_backend_family: {ccbd.get("namespace_backend_family")}',
        f'ccbd_namespace_backend_impl: {ccbd.get("namespace_backend_impl")}',
        f'ccbd_namespace_id: {ccbd.get("namespace_id")}',
        f'ccbd_namespace_session_name: {ccbd.get("namespace_session_name")}',
        f'ccbd_namespace_ipc_kind: {ccbd.get("namespace_ipc_kind")}',
        f'ccbd_namespace_ipc_ref: {ccbd.get("namespace_ipc_ref")}',
