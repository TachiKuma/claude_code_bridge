...
class RuntimeService:
    ...
    def attach(
        ...
        *,
        ...
        pane_ref: dict | None = None,
        namespace_ref: dict | None = None,
    ...
    def mutate_runtime_authority(
        ...
        **overrides,
        ...
        updated = self.attach(
            ...
            backend_family=overrides.pop('backend_family', runtime.backend_family),
            backend_impl=overrides.pop('backend_impl', runtime.backend_impl),
            pane_ref=overrides.pop('pane_ref', runtime.pane_ref),
            namespace_ref=overrides.pop('namespace_ref', runtime.namespace_ref),
            daemon_ref=overrides.pop('daemon_ref', runtime.daemon_ref),
            ...
            tmux_window_name=overrides.pop('tmux_window_name', runtime.tmux_window_name),
            tmux_window_id=overrides.pop('tmux_window_id', runtime.tmux_window_id),
