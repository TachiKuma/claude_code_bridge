...
- Depends on: `ccbd-windows-control-plane-transport`
- Nature: functional
...
- Failure recovery: keep control-plane transport, provider/recovery/user-surface/release changes out of this feature.
