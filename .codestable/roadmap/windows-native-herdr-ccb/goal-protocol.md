...
本文件复制到 `.codestable/roadmap/windows-native-herdr-ccb/goal-protocol.md` 后，由 `/goal` 会话读取。详细执行规则拆到同目录子文档，避免单个 md 超过 300 行。

## 1. 先读文件

- `.codestable/roadmap/windows-native-herdr-ccb/goal-state.yaml`
- `.codestable/roadmap/windows-native-herdr-ccb/goal-plan.md`
...
- `.codestable/roadmap/windows-native-herdr-ccb/goal-features/*.md`
- `.codestable/roadmap/windows-native-herdr-ccb/goal-protocol-feature-loop.md`
- `.codestable/roadmap/windows-native-herdr-ccb/goal-protocol-gates.md`
- `.codestable/roadmap/windows-native-herdr-ccb/goal-protocol-audit.md`
...
Plan: .codestable/roadmap/windows-native-herdr-ccb/goal-plan.md
