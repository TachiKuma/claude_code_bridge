...
- `herdr-v0.8-version`: exit=0, elapsed=15ms
- `herdr-v0.8-api-help`: exit=0, elapsed=15ms
...
- `herdr-v0.8-session-list`: exit=0, elapsed=15ms
- `herdr-v0.8-status`: exit=0, elapsed=15ms
