...
- pane_id=w2:p4 title=agent2 display_agent=agent2
  token: ccb_is_cmd=0
  token: ccb_managed_by=ccbd
  token: ccb_order=1
  token: ccb_project_id=575a971fdf5a0c497a48228040a14841fb4529aaa476beb21d34e53f1629bc03
  token: ccb_session_id=ccb-agent2-4fe0f411967b
  token: ccb_slot=agent2
- pane_id=w2:p3 title=agent1 display_agent=agent1
  token: ccb_is_cmd=0
  token: ccb_managed_by=ccbd
  token: ccb_order=0
  token: ccb_project_id=575a971fdf5a0c497a48228040a14841fb4529aaa476beb21d34e53f1629bc03
  token: ccb_session_id=ccb-agent1-bf45e076a4ae
  token: ccb_slot=agent1
- pane_id=w2:p2 title=cmd display_agent=cmd
...
- pane_id=w2:p1 exit_code=0 tail=ocket 'D:\.c8\rs\575a971fdf5a0c497a48228040a14841fb452
...
- pane_id=w2:p4 exit_code=0 tail=Welcome to Claude Code v2.1.220
...
- pane_id=w2:p3 exit_code=0 tail=  Sign in with ChatGPT to use Codex as part of
your paid plan
...
and Enterprise pl
- pane_id=w2:p2 exit_code=0 tail=运行程序的名称。请检查名称的拼写，如果包括路径，请确
保路径正确，然后再试一次。
所在位置 行:1 字符: 1
