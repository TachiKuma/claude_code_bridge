...
- `herdr-v0.8-version`: exit=0, elapsed=32ms
- `herdr-v0.8-api-help`: exit=0, elapsed=35ms
- `herdr-v0.8-status-server`: exit=0, elapsed=33ms
- `herdr-v0.8-plugin-list`: exit=0, elapsed=37ms
- `herdr-v0.8-help`: exit=0, elapsed=31ms
