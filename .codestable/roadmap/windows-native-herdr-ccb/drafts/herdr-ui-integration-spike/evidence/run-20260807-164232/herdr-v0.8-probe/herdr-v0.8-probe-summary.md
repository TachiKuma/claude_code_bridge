...
- `herdr-v0.8-version`: exit=0, elapsed=28ms
- `herdr-v0.8-api-help`: exit=0, elapsed=29ms
- `herdr-v0.8-status-server`: exit=0, elapsed=28ms
- `herdr-v0.8-plugin-list`: exit=0, elapsed=29ms
- `herdr-v0.8-help`: exit=0, elapsed=27ms
- `herdr-v0.8-session-list`: exit=0, elapsed=33ms
- `herdr-v0.8-status`: exit=0, elapsed=28ms
