...
- `herdr-v0.8-api-help`: exit=0, elapsed=40ms
- `herdr-v0.8-status-server`: exit=0, elapsed=41ms
- `herdr-v0.8-plugin-list`: exit=0, elapsed=43ms
- `herdr-v0.8-help`: exit=0, elapsed=41ms
- `herdr-v0.8-session-list`: exit=0, elapsed=41ms
- `herdr-v0.8-status`: exit=0, elapsed=40ms
