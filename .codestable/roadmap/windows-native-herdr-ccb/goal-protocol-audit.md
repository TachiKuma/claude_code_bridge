...
```bash
python3 <cs-onboard skill 目录>/tools/codestable-goal-consistency-gate.py --roadmap .codestable/roadmap/windows-native-herdr-ccb
```
...
写 `.codestable/roadmap/windows-native-herdr-ccb/goal-audit.md`：
...
# windows-native-herdr-ccb Goal 最终审计
...
同时写 `.codestable/roadmap/windows-native-herdr-ccb/goal-evidence-summary.md` 或在 goal-audit 第 7 节等价内嵌：
