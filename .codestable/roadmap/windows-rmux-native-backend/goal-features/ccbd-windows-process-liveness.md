...
- Roadmap item: $slug
- Feature dir: $dir
- Design: $dir/ccbd-windows-process-liveness-design.md
- Checklist: $dir/ccbd-windows-process-liveness-checklist.yaml
- Design review: $dir/ccbd-windows-process-liveness-design-review.md
- Review output: $dir/ccbd-windows-process-liveness-review.md
- QA output: $dir/ccbd-windows-process-liveness-qa.md
- Acceptance output: $dir/ccbd-windows-process-liveness-acceptance.md
- Depends on: none
- Feature kind: $(System.Collections.Hashtable.kind)

## 2. Deliverable

共享跨平台 pid liveness helper 与 Windows WinAPI backend
