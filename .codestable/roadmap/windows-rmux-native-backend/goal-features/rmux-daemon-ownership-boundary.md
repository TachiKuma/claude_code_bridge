...
- Roadmap item: $slug
- Feature dir: $dir
- Design: $dir/rmux-daemon-ownership-boundary-design.md
- Checklist: $dir/rmux-daemon-ownership-boundary-checklist.yaml
- Design review: $dir/rmux-daemon-ownership-boundary-design-review.md
- Review output: $dir/rmux-daemon-ownership-boundary-review.md
- QA output: $dir/rmux-daemon-ownership-boundary-qa.md
- Acceptance output: $dir/rmux-daemon-ownership-boundary-acceptance.md
- Depends on: mux-backend-contract, windows-namespace-ipc-schema
- Feature kind: $(System.Collections.Hashtable.kind)

## 2. Deliverable

Rmux daemon discovery/start/health/crash/cleanup ownership
