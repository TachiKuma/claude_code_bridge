...
- Roadmap item: $slug
- Feature dir: $dir
- Design: $dir/rmux-send-capture-logging-design.md
- Checklist: $dir/rmux-send-capture-logging-checklist.yaml
- Design review: $dir/rmux-send-capture-logging-design-review.md
- Review output: $dir/rmux-send-capture-logging-review.md
- QA output: $dir/rmux-send-capture-logging-qa.md
- Acceptance output: $dir/rmux-send-capture-logging-acceptance.md
- Depends on: rmux-backend-core
- Feature kind: $(System.Collections.Hashtable.kind)

## 2. Deliverable

Rmux send/capture/logging semantics
