...
- Roadmap item: $slug
- Feature dir: $dir
- Design: $dir/ccbd-windows-tcp-loopback-transport-design.md
- Checklist: $dir/ccbd-windows-tcp-loopback-transport-checklist.yaml
- Design review: $dir/ccbd-windows-tcp-loopback-transport-design-review.md
- Review output: $dir/ccbd-windows-tcp-loopback-transport-review.md
- QA output: $dir/ccbd-windows-tcp-loopback-transport-qa.md
- Acceptance output: $dir/ccbd-windows-tcp-loopback-transport-acceptance.md
- Depends on: ccbd-control-plane-transport-seam
- Feature kind: $(System.Collections.Hashtable.kind)

## 2. Deliverable

Windows TCP loopback control-plane transport adapter
