...
<!-- For checkpoint task examples and patterns, see @E:/GitHub开源项目/TachiKuma/claude_code_bridge/.gemini/get-shit-done/references/checkpoints.md -->
...
See `E:/GitHub开源项目/TachiKuma/claude_code_bridge/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/GitHub开源项目/TachiKuma/claude_code_bridge/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/GitHub开源项目/TachiKuma/claude_code_bridge/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
