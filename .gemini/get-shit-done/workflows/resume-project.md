...
<required_reading>
@E:/GitHub开源项目/TachiKuma/claude_code_bridge/.gemini/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "E:/GitHub开源项目/TachiKuma/claude_code_bridge/.gemini/get-shit-done/bin/gsd-tools.cjs" init resume)
