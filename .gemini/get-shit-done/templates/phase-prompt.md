...
<!-- For checkpoint task examples and patterns, see @D:/Python/GitHub/claude_code_bridge/.gemini/get-shit-done/references/checkpoints.md -->
...
See `D:/Python/GitHub/claude_code_bridge/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Python/GitHub/claude_code_bridge/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Python/GitHub/claude_code_bridge/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
