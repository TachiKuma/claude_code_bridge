...
Reference full template: `D:/Python/GitHub/claude_code_bridge/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Python/GitHub/claude_code_bridge/.gemini/get-shit-done/templates/state.md`.
