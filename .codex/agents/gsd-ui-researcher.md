...
Use template from `D:/Python/GitHub/claude_code_bridge/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Python/GitHub/claude_code_bridge/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/Python/GitHub/claude_code_bridge/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
