...
Use template from `E:/GitHub开源项目/TachiKuma/claude_code_bridge/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/GitHub开源项目/TachiKuma/claude_code_bridge/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/GitHub开源项目/TachiKuma/claude_code_bridge/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
