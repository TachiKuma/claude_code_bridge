...
CCB 8.1.0 已把 Flutter 版 CCB Mobile 源码放入 [`mobile/`](../mobile/)，并在 GitHub Release 中发布 Android APK：

- [下载 CCB Mobile v8.1.0 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.1.0/ccb-mobile-v8.1.0.apk)
