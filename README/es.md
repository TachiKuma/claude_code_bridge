...
CCB 8.6.3 incluye el código Flutter de CCB Mobile en [`mobile/`](../mobile/) y publica el APK Android mediante GitHub Releases:

- [Descargar CCB Mobile v8.6.3 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.3/ccb-mobile-v8.6.3.apk)
