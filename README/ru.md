...
CCB 8.6.4 включает Flutter source CCB Mobile в [`mobile/`](../mobile/) и публикует Android APK через GitHub Releases:

- [Скачать CCB Mobile v8.6.4 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.4/ccb-mobile-v8.6.4.apk)
